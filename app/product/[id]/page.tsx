...
export default function ProductPage(){
 ...
 return <ProductContent product={p} qty={qty} setQty={setQty} message={message} setMessage={setMessage} router={router}/>;
}

function ProductContent({product:p,qty,setQty,message,setMessage,router}:{product:Product;qty:number;setQty:(n:number)=>void;message:string;setMessage:(s:string)=>void;router:ReturnType<typeof useRouter>}){
